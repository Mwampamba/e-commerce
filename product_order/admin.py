...
class OrderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = [ 'full_name', 'user', 'order_number', 'payment', 'phone', 'first_name', 'last_name', 'order_number', 'phone', 'email', 'city', 'address_line_1','address_line_2', 'country', 'order_note', 'order_total', 'tax', 'status', 'is_ordered', 'order_date']
    list_per_page = 10
